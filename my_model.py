...
def load_model1():
    return keras.models.load_model('models/dataset1.h5')

def load_model2():
    return keras.models.load_model('models/eye_disease_model.h5')

def load_model3():
    return keras.models.load_model('models/model-3.h5')
